...
while not done:
    ...
    if choice == "1":
        ...
        axs[0, 1].bar([0, 1, 2], [protein_sum, fats_sum, carbs_sum], width=0.4, label='Actual', color='blue')
        axs[0, 1].bar([0.5, 1.5, 2.5], [PROTEIN_GOAL, FAT_GOAL, CARBS_GOAL], width=0.4, label='Goal', color='orange')
